(define (problem zeno_4_4_4_7229)
  (:domain zenotravel)
  (:objects c0 c1 c2 c3 - city p0 p1 p2 p3 - person a0 a1 a2 a3 - aircraft f0 f1 f2 f3 f4 - flevel)
  (:init (next f0 f1) (next f1 f2) (next f2 f3) (next f3 f4)
         ...
         (at-aircraft a3 c1) (fuel-level a3 f1) (not-refueling a3)
  )
  (:goal (and (at-person p0 c2) (at-person p1 c0) (at-person p2 c2) (at-person p3 c0)))
)
