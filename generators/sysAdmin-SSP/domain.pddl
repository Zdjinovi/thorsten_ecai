...
(define (domain sysadmin-slp)
	...
	(:requirements :typing :equality :probabilistic-effects :existential-preconditions :conditional-effects :negative-preconditions :universal-preconditions :equality)
	(:types
		comp
	)
